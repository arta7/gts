 ...
 let key =Object.keys(data[0]);
  ...
  const loaderReportData = (values:any) => {
    ...
    isManager: user && user?.workgroups[0].isManager,
      json:`[{"componentId":${values.componentId?values.componentId:1},"year":${Number(values.year) ? Number(values.year) : 1402},"organizationId":${Number(values.organizationId) ? Number(values.organizationId) : -1}}]`,
    }).then((res) => {
